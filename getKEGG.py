...
def write_kegg_id_name_jsons(keggdir):
    ...
    kegg_types = ["rclass"] #["pathway","enzyme","reaction","compound"]
...
def write_reaction_edges_json(keggdir):
    ...
    indir = keggdir+'reaction_detailed/' ## Should be the detailed reactions
...
def main():
    keggdir = "kegg/" + str(datetime.datetime.now().date()) + "/"
